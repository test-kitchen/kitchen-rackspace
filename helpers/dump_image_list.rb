...
i_care_about = {
  'Arch 2014.10 (PVHVM)' => %w(arch arch-2014 arch-2014.10),
  'CentOS 7 (PVHVM)' => %w(centos centos-7 centos-7.0),
  'CentOS 6.5 (PVHVM)' => %w(centos-6 centos-6.5),
  'CentOS 5.11' => %w(centos-5 centos-5.11),
  ...
  'Debian 6 (Squeeze)' => %w(debian-6 debian-6.0.10),
  ...
  'Gentoo 14.4 (PVHVM)' => %w(gentoo gentoo-14 gentoo-14.4),
  'OpenSUSE 13.1 (PVHVM)' => %w(opensuse opensuse-13 opensuse-13.1),
  'Red Hat Enterprise Linux 6.6 (PVHVM)' => %w(redhat redhat-6 redhat-6.6),
  'Red Hat Enterprise Linux 5.11' => %w(redhat-5 redhat-5.11),
  ...
  'Vyatta Network OS 6.7R4' => %w(vyatta vyatta-6 vyatta-6.7 vyatta-6.7R4),
